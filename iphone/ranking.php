         ...
         <div id="tab1" class="swiper-slide">
            ...
            <div class="meta-notes">
                ...
                <div class="grad-item">
                    ...
                    <p>
                    ①本品の継続摂取によりBMIが高めの方におなかの脂肪（体脂肪・内臓皮下脂肪）・体重を減らすことで高めのBMIを低下させる ②本品の摂取により食事から摂取した脂肪の吸収を抑える ③機能性関与成分サラシノールが食事から摂取した糖の吸収を抑える ④機能性関与成分サラシノールの継続摂取により腸内環境を整える（おなかの中のビフィズス菌を増やす）
                    </p>
                </div>
            </div>
            <?php endif; ?>
